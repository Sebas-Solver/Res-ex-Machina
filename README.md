...
Instalación: `npm install @res-ex-machina/sdk viem`
...
| **v1.2** | ✅ Publicado | SDK npm [`@res-ex-machina/sdk`](https://www.npmjs.com/package/@res-ex-machina/sdk) — integración trivial para humanos y agentes (#27) |
